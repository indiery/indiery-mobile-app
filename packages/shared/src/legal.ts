...
export const legalPolicies: LegalPolicy[] = [
  {
    ...
    updatedAt,
    summary: 'How Indiery handles personal data when customers use the customer app, website, delivery, payment, tracking, and support services.',
    sections: [
      {
        ...
        body: [
          ...
          'For privacy questions, access or correction requests, account deletion, or grievances, contact our privacy team at support@indiery.com.',
          'This policy should be read together with the Customer Terms and Conditions and the notices shown immediately before the Customer app requests sensitive permissions.'
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          'Account and profile data is kept while the account is active. Push tokens are kept while needed for notifications. Customer location, booking, proof, payment, wallet, safety, support, and audit records are retained only for service, verification, fraud prevention, dispute, tax, accounting, safety, and legal needs.',
      ...
      },
      {
        ...
        body: [
          ...
          'Customers can decline or later disable location or notification permissions in device settings. The related feature may be unavailable, but unrelated app features should remain accessible where practical.',
      ...
      },
      {
        ...
        body: [
          ...
          'Privacy contact and grievance channel: support@indiery.com. Website: https://www.indiery.com.'
        ]
      }
    ]
  },
  {
    ...
    updatedAt,
    summary: 'The rules governing customer accounts, delivery bookings, payments, tracking, cancellations, and use of the Indiery Customer app and website.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Customers may stop using the service at any time and may request account deletion. Obligations and records that by their nature must survive, including payment, dispute, safety, and legal obligations, continue as permitted by law.'
        ]
      },
      {
...
export const partnerPrivacyPolicy: LegalPolicy = {
  id: 'privacy',
  title: 'Driver Partner Privacy Policy',
  updatedAt,
  summary: 'How Indiery handles personal data when Driver Partners register, complete KYC, go online, accept deliveries, share live location, receive earnings, and request payouts.',
  sections: [
    {
      heading: 'Developer and scope',
      body: [
...
export const partnerTermsPolicy: LegalPolicy = {
  id: 'terms',
  title: 'Driver Partner Terms and Conditions',
  updatedAt,
  summary: 'The rules governing Driver Partner registration, KYC, availability, deliveries, safety, earnings, wallet settlement, cancellations, and payouts on Indiery.',
  sections: [
    {
...
export const partnerLegalPolicies: LegalPolicy[] = [
  partnerPrivacyPolicy,
  partnerTermsPolicy,
  ...legalPolicies.filter((policy) => policy.id !== 'privacy' && policy.id !== 'terms')
];
